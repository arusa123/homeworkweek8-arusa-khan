...
public void setSecondNumber(double secondNumber){             //no return type
...
public double getMultiplicationResult(){             //multiply two variables

        return (firstNumber*secondNumber);
}
public double getDivisionResult() {            //division return
    ...
    public static void main(String[] args) {
        Programme18_SimpleCalculator obj = new Programme18_SimpleCalculator();
